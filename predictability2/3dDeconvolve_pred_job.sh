...
if [ ! -d predictability2 ]
    then
        mkdir predictability2
fi
...
if [ -f $TIMING_POS ] && [ ! -f predictability_deconv+orig.BRIK ]
    then
        ...
        ${AFNI_BIN}/3dDeconvolve \
            ...
            -stim_times_AM2 7 ${TIMING_FREQ} 'dmUBLOCK' -stim_label 7 "freq" \
            -stim_times_AM2 8 ${TIMING_LENG} 'dmUBLOCK' -stim_label 8 "leng" \
